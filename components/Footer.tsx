        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-indigo-100">
              <FooterLink href="#">Color Theory Guide</FooterLink>
              <FooterLink href="#">Accessibility Tips</FooterLink>
              <FooterLink href="#">Design Principles</FooterLink>
              <FooterLink href="#">UI/UX Best Practices</FooterLink>
            </ul>
          </div>
...
function SocialIcon({ type }: { type: 'twitter' | 'github' | 'dribbble' | 'instagram' }) {
  return (
    <motion.a
      href="#"
